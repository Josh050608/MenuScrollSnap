...
#ifndef SCROLLSNAP_SWIFT_H
#define SCROLLSNAP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ScrollSnap",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10ScrollSnap11AppDelegate")
...
@class NSCoder;
/// <code>MenuBarView</code> manages the menu bar’s appearance and interactions.
SWIFT_CLASS("_TtC10ScrollSnap11MenuBarView")
...
@class NSEvent;
/// <code>OverlayView</code> coordinates rendering and event handling across screens using subviews.
SWIFT_CLASS("_TtC10ScrollSnap11OverlayView")
...
SWIFT_CLASS("_TtC10ScrollSnap13OverlayWindow")
...
/// <code>SelectionRectangleView</code> manages the selection rectangle’s appearance and resizing.
SWIFT_CLASS("_TtC10ScrollSnap22SelectionRectangleView")
@interface SelectionRectangleView : NSView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect SWIFT_UNAVAILABLE;
@end

SWIFT_CLASS("_TtC10ScrollSnap12SettingsView")
@interface SettingsView : NSView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect SWIFT_UNAVAILABLE;
@end

SWIFT_CLASS("_TtC10ScrollSnap24SettingsWindowController")
...
SWIFT_CLASS("_TtC10ScrollSnap13ThumbnailView")
...
@interface ThumbnailView (SWIFT_EXTENSION(ScrollSnap)) <NSDraggingSource, NSPasteboardItemDataProvider>
